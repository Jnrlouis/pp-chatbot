...
export default function Home() {
  ...
  const [messages, setMessages] = useState([
    {
      role: "assistant",
      content: "Yo, this is PP Chat Bot! wtf do you want",
    },
  ]);
    ...
    <main className="flex min-h-screen flex-col items-center justify-between px-24 py-5">
      ...
      <div className="flex  h-[35rem] w-[40rem] flex-col items-center bg-gray-600 rounded-xl">
        <div className=" h-full flex flex-col gap-2 overflow-y-auto py-8 px-3 w-full">
          ...
          {isLoading ? <div className="self-start  bg-gray-200 text-gray-800 w-max max-w-[18rem] rounded-md px-4 py-3 h-min">*hmm...*</div> : ""}
        </div>
